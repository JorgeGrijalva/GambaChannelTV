...
public final class TrackSelectionDialog extends Dialog {
    ...
    public static TrackSelectionDialog createForTrackSelector(
        ...
        TrackSelectionDialog trackSelectionDialog = new TrackSelectionDialog(context);
    ...
    public TrackSelectionDialog(final Context context) {
        super(context);
    ...
    private final class FragmentAdapter extends FragmentPagerAdapter {
        ...
        public CharSequence getPageTitle(int position) {
            return getTrackTypeString(getContext().getResources(), tabTrackTypes.get(position));
        }
    }
